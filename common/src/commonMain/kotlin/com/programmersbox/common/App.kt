...
private fun Solitaire(
    deck: Deck<Card> = rememberDeck(),
    info: SolitaireInfo = viewModel(SolitaireInfo::class) { SolitaireInfo(deck) },
) {
                    ...
                    Row(
                        ...
                        Box(
                            ...
                            EmptyCard(
                                ...
                                repeat(DRAW_AMOUNT) {
                                    if (deck.size > 0) {
                                        info.drawList.add(deck.draw())
                                    } else {
                                        deck.addCard(*info.drawList.toTypedArray())
                                        info.drawList.clear()
                                    }
                                }
                            }
